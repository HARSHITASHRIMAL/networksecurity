...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path: str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,  
         ...
         # ✅ NEW: File path to save the imputer only
        self.imputer_object_file_path: str = os.path.join(
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_confiig:TrainingPipelineConfig):
        self.model_trainer_dir:str=os.path.join(
            training_pipeline_confiig.artifact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME
        )
